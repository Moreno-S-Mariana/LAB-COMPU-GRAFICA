...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Limpiar la ventana
		glClearColor(0.0f, 0.0f, 1.9f, 0.0f);
	...
	/*
		...
		//******************************************EJERCICIO DE CLASE GRUA SIN BASE Y SIN RUEDAS ******************************************

		//SE REINICIA LA MATRIZ DE MODELO
		model = glm::mat4(1.0);
		...
		//***************************************Creacion de la rueeda lateral izquierda trasera de la grua***********************************
		...
		//***************************************Creacion de la rueeda lateral derecha trasera de la grua***********************************
		...
		//***************************************Creacion de la rueeda lateral derecha frontal de la grua***********************************
		...
		meshList[2]->RenderMeshGeometry();
		model = modelaux2;
		//***************************************Creacion de la rueeda lateral izquierda frontal de la grua***********************************
		...
		//******************************************CREACION DE LA PRIMERA ARTICULACION DE LA GRUA *********************************
		...
		//****************************************** CREACION DEL PRIMER BRAZO DE LA GRUA ******************************************
		...
		//******************************************CREACION DE LA SEGUNDA ARTICULACION DE LA GRUA ***********************************
		...
		//****************************************** CREACION DEL SEGUNDO BRAZO DE LA GRUA ******************************************
		...
		//******************************************CREACION DE LA TERCERA ARTICULACION DE LA GRUA ******************************************
		...
		//******************************************CREACION DEL TERCER BRAZO DE LA GRUA ******************************************
		...
		//******************************************CREACION DEL CUARTO BRAZO DE LA GRUA ******************************************
		...
		*/
		...
		//****************************************** TORSO ***************************************************************************
		color = glm::vec3(0.91f, 0.08f, 0.48f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
		...
		//*********************************************** MODELADO DE LA PATITA FRONTAL DERECHA ***************************************************
		...
		// ***************************************** MODELADO DE LA PATITA FRONTAL IZQUIERDA ********************************************************
		...
		// ***************************************** MODELADO DE LA PATITA TRASERA DERECHA ********************************************************
		...
		// ***************************************** MODELADO DE LA PATITA TRASERA IZQUIERDA ********************************************************
